    ...
    case '$': {
      ...
      if (IsDigit(char_)) {
        ...
        static std::vector<std::pair<const char *, Register>> regs =
        {
          ...
          std::make_pair("aarch64_cntvct",      Register::AARCH64_CNTVCT),
          std::make_pair("aarch64_cntfrq",      Register::AARCH64_CNTFRQ),
          std::make_pair("aarch64_far",         Register::AARCH64_FAR   ),
          std::make_pair("aarch64_vbar",        Register::AARCH64_VBAR  ),
