...
llvm::raw_ostream &operator<<(llvm::raw_ostream &os, Register reg)
{
  switch (reg) {
    ...
    case Register::AARCH64_CNTVCT:   return os << "$aarch64_cntvct";
    case Register::AARCH64_CNTFRQ:   return os << "$aarch64_cntfrq";
    case Register::AARCH64_FAR:      return os << "$aarch64_far";
    case Register::AARCH64_VBAR:     return os << "$aarch64_vbar";
